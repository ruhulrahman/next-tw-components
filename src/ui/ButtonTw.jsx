...
const ButtonTw = ({
  ...
  const baseVariants = {
    ...
    alternative:
      "text-gray-900 bg-white border border-gray-200 hover:bg-gray-100 hover:text-blue-700 focus:ring-gray-200 dark:bg-theme-dark dark:text-gray-400 dark:border-gray-600 dark:hover:text-white dark:hover:bg-gray-700",
    ...
    light:
      "text-gray-900 bg-white border border-gray-300 hover:bg-gray-100 focus:ring-gray-200 dark:bg-theme-dark dark:text-white dark:border-gray-600 dark:hover:bg-gray-700 dark:hover:border-gray-600 dark:focus:ring-gray-700",
    green:
    ...
    transparent:
      "text-gray-900 bg-transparent hover:bg-gray-100 focus:ring-gray-200 dark:bg-theme-dark dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white dark:focus:ring-gray-800",
    ...
    outline:
      "text-gray-900 border border-gray-300 hover:bg-gray-100 focus:ring-gray-200 dark:text-gray-400 dark:border-gray-600 dark:hover:bg-gray-700 dark:hover:text-white dark:focus:ring-gray-800",
  ...
  const gradientVariants = {
    ...
    green:
      "bg-gradient-to-r from-green-400 via-green-500 to-green-600 hover:bg-gradient-to-br focus:ring-green-300 dark:focus:ring-green-800",
    ...
    tealToLime:
      "bg-gradient-to-r from-teal-200 to-lime-200 hover:bg-gradient-to-l hover:from-teal-200 hover:to-lime-200 focus:ring-lime-200 dark:focus:ring-teal-700 text-gray-900",
    redToYellow:
      "bg-gradient-to-r from-red-200 via-red-300 to-yellow-200 hover:bg-gradient-to-bl focus:ring-red-100 dark:focus:ring-red-400 text-gray-900",
  };

  const socialVariants = {
    facebook:
      "bg-[#3b5998] hover:bg-[#3b5998]/90 focus:ring-[#3b5998]/50 dark:focus:ring-[#3b5998]/55 text-gray-300",
    twitter:
      "bg-[#1da1f2] hover:bg-[#1da1f2]/90 focus:ring-[#1da1f2]/50 dark:focus:ring-[#1da1f2]/55",
    github:
      "bg-[#24292F] hover:bg-[#24292F]/90 focus:ring-[#24292F]/50 dark:focus:ring-gray-500 dark:hover:bg-[#050708]/30 text-gray-300",
    google:
    ...
    metamask:
      "text-gray-900 bg-white hover:bg-gray-100 border border-gray-200 focus:ring-gray-100 dark:focus:ring-gray-600 dark:bg-theme-dark dark:border-gray-700 dark:text-white dark:hover:bg-gray-700",
    opera:
      "text-gray-900 bg-white hover:bg-gray-100 border border-gray-200 focus:ring-gray-100 dark:focus:ring-gray-600 dark:bg-theme-dark dark:border-gray-700 dark:text-white dark:hover:bg-gray-700",
    bitcoin:
      "bg-[#FF9119] hover:bg-[#FF9119]/80 focus:ring-[#FF9119]/50 dark:hover:bg-[#FF9119]/80 dark:focus:ring-[#FF9119]/40",
    paypal:
      "bg-[#F7BE38] hover:bg-[#F7BE38]/90 focus:ring-[#F7BE38]/50 dark:focus:ring-[#F7BE38]/50",
    applePay:
      "bg-[#050708] hover:bg-[#050708]/80 focus:ring-[#050708]/50 dark:hover:bg-[#050708]/40 dark:focus:ring-gray-600",
    ...
    mastercard:
      "text-gray-900 bg-white hover:bg-gray-100 border border-gray-200 focus:ring-gray-100 dark:focus:ring-gray-600 dark:bg-theme-dark dark:border-gray-700 dark:text-white dark:hover:bg-gray-700",
    ethereum:
      "text-gray-900 bg-gray-100 hover:bg-gray-200 focus:ring-gray-100 dark:focus:ring-gray-500",
  };
  ...
  const getVariantClass = () => {
    if (variant.startsWith("outline."))
      return outlineVariants[variant.split(".")[1]] || "";
    if (variant.startsWith("gradient."))
      return gradientVariants[variant.split(".")[1]] || "";
    if (variant.startsWith("social."))
      return socialVariants[variant.split(".")[1]] || "";
