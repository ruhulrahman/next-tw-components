...
const Input = ({
  ...
  const [internalValue, setInternalValue] = React$1.useState(externalValue || defaultValue || "");
  ...
  }, /*#__PURE__*/React.createElement(ri.RiCloseLine, {
  ...
  }, showPassword ? /*#__PURE__*/React.createElement(fa.FaEyeSlash, {
    className: "w-5 h-5"
  }) : /*#__PURE__*/React.createElement(fa.FaEye, {
    className: "w-5 h-5"
...
const SelectSearch = /*#__PURE__*/React$1.forwardRef(({
  ...
  return /*#__PURE__*/React$1.createElement("div", {
    ...
    onClick: handleClear
  }, /*#__PURE__*/React$1.createElement(ri.RiCloseLine, {
    className: "w-4.5 h-4.5"
...
const SwitchButton = ({
  ...
  const [isEnabled, setIsEnabled] = React$1.useState(enabled);
  const [textWidth, setTextWidth] = React$1.useState({
    enabled: 0,
    disabled: 0
  });
  const enabledTextRef = React$1.useRef(null);
  const disabledTextRef = React$1.useRef(null);
  React$1.useEffect(() => {
...
const AvatarUpload = ({
  ...
  const [preview, setPreview] = React$1.useState(value && typeof value === "string" ? value : null);
  const [showModal, setShowModal] = React$1.useState(false);
  const [showCrop, setShowCrop] = React$1.useState(false);
  const [crop, setCrop] = React$1.useState({
    unit: "px",
    x: 80,
    y: 35,
    width: 250,
  ...
  const [srcImage, setSrcImage] = React$1.useState(null);
  const [originalFileName, setOriginalFileName] = React$1.useState("");
